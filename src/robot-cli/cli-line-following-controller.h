...
#define LINE_FOLLOWING_CONTROLLER_COMMANDS                                                                                                    \
    ...
    {cliLineFollowingController_getErrorDeadbandHalfWidth, "get-error-deadband", "",           "get error deadband", 0, 0}, \
    {cliLineFollowingController_setErrorDeadbandHalfWidth, "set-error-deadband", "<deadband>", "set error deadband", 1, 1},
